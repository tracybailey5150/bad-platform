...
const solutions = [
  ...
  },
  {
    ...
    description:
      'We also build the customer-facing side of the business -- branded websites, media tools, content workflows, and creative platforms that connect directly to the systems behind the scenes.',
    features: [
      'Branded business websites with custom design',
      'Public-facing tools and client portals',
      'Content and media workflow platforms',
      'Image and video utility tools',
      'Creative platform development and integration',
      'Connected experiences tied to backend systems',
    ],
    useCases: [
      'Businesses needing a public-facing platform that connects to their internal systems',
      'Companies with creative or media workflows that need dedicated tooling',
      'Organizations that want their website, lead capture, and operations built as one system',
    ],
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
